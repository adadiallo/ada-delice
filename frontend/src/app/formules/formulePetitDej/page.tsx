...
export default function MenuDuJour() {
  ...
  return (
    <>
      ...
      <div className=" min-h-screen bg-gray-100 px-6 md:px-20 py-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-6 text-center">      Nos <span className="text-[#F28C28]">Menus Petit Déjeuner</span>
    </h1>
